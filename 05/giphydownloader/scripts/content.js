...
var _textProcessing = require('./utils/text-processing.js');

var _occurenceCounting = require('./utils/occurence-counting.js');
...
chrome.runtime.onMessage.addListener(function (msg, sender, response) {
  if (msg.from === 'popup' && msg.subject === 'Wiki-Giphy') {
    ...
    var tags = document.body.querySelectorAll('div, span, mark, li, b, i, p, a, h1, h2, h3, h4'),
        corpus = (0, _textProcessing.prepareTextcorpus)(tags),
        cleanedCorpus = (0, _textProcessing.cleanupTextcorpus)(corpus),
        tokens = (0, _textProcessing.stopwordRemoval)(cleanedCorpus),
        occurences = (0, _occurenceCounting.countOccurences)(tokens),
        sortedOccurences = (0, _occurenceCounting.sortObject)(occurences, 'count'),
        buzzwords = sortedOccurences[0].value + '-' + sortedOccurences[1].value;

    // highlight the search buzzwords in the page's DOM
    (0, _textProcessing.highlightText)(tags, sortedOccurences[0].value, 'first');
    (0, _textProcessing.highlightText)(tags, sortedOccurences[1].value, 'second');
...
},{"./utils/occurence-counting.js":3,"./utils/text-processing.js":4,"mark.js":1}],3:[function(require,module,exports){
"use strict";
...
exports.prepareTextcorpus = prepareTextcorpus;
exports.cleanupTextcorpus = cleanupTextcorpus;
exports.stopwordRemoval = stopwordRemoval;
exports.highlightText = highlightText;
function prepareTextcorpus(nodes) {
  var textnodes = [];
...
function highlightText(nodes, word, className) {
  var found = void 0;
  for (var i = 0; i < nodes.length; i++) {
    if (nodes[i].textContent.toLowerCase().includes(word)) {
      found = nodes[i];
      var instance = new Mark(nodes[i]);
      instance.mark(word, { className: className });
      break;
    }
  }
}
