...
function handleClicks() {
  (0, _jquery2.default)('#giflist').off().on('click', 'li', function () {
    var src = (0, _jquery2.default)(this).find('img').attr('src'),
        searchTerm = (0, _jquery2.default)('h3 > #first').text() + '-' + (0, _jquery2.default)('h3 > #second').text();
...
function setDOMGif(gif) {
  console.log(gif);
  (0, _jquery2.default)('#giflist').append((0, _jquery2.default)('<li><img class=\'gif\' src=\'' + gif + '\'/></li>'));
  handleClicks();
}
...
function giphyApiCall(searchUrl, searchTerm, errorCallback) {
  ...
  fetch(searchUrl).then(function (response) {
    ...
    for (var g = 0; g < gifs.data.length; g++) {
...
function setDOMSearchTerm(searchTerm) {
  var buzzwords = searchTerm.split('-');
  (0, _jquery2.default)('#first').text(buzzwords[0]);
  (0, _jquery2.default)('#second').text(buzzwords[1]);
  (0, _jquery2.default)('h3 > span').addClass('show');
